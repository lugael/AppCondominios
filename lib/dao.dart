...
class DAO {
  ...
  Future _init() async {
    ...
    db = await openDatabase(path,
        version: dbVersion, onCreate: _createDB, onUpgrade: _upgradeDB);
  }
  ...
  Map<String, dynamic> _mapSessao(Sessao sessao) {
    return {
      ...
      'condominio_id': sessao.usuario?.morador?.condominio?.id,
      'condominio_nome': sessao.usuario?.morador?.condominio?.nome,
  ...
  Sessao _sessao(Map<String, dynamic> map) {
    return Sessao(
        ...
        usuario: Usuario(
            ...
            morador: Morador(
                id: map['morador_id'],
                nome: map['morador_nome'],
                condominio: Condominio(
                    id: map['condominio_id'], nome: map['condominio_nome']))),
        inicio: map['datahora_inicio'] == null
            ? null
            : DateTime.fromMillisecondsSinceEpoch(map['datahora_inicio']));
  }
}
